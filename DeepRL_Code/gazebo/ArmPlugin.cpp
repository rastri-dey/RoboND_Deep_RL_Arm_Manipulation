...
#define REWARD_GAIN 5.0f
#define Interim_offset 0.5f
#define alpha 0.4f
...
namespace gazebo
{
    ...
    void ArmPlugin::onCollisionMsg(ConstContactsPtr &contacts)
    {
        ...
        for (unsigned int i = 0; i < contacts->contact_size(); ++i)
        {
            ...
            // Collision check between arm and object, Issue learning reward
            // Gripper link colides with tube
        ...
        if( hadNewState && !newReward )
        {
            ...
            else
            {
                ...
                if( episodeFrames > 1 )
                {
                    ...
                    rewardHistory = avgGoalDelta * REWARD_GAIN - Interim_offset;
